...
function isPublicStatus(value: string): value is (typeof PUBLIC_STATUSES)[number] {
  ...
  return (
    <SectionContainer className="py-10 sm:py-14">
      <div className="max-w-3xl">
        <p className="text-xs font-bold uppercase tracking-[0.2em] text-lime-300">Tournament Arena</p>
        <h1 className="mt-2 text-3xl font-black tracking-tight text-white sm:text-5xl">Tournaments</h1>
        <p className="mt-3 text-sm leading-6 text-slate-400 sm:text-base">Browse live and upcoming competitions, compare entry fees and prize pools, and find your next match.</p>
      </div>
      ...
      {totalPages > 1 ? (
        <nav aria-label="Tournament pagination" className="mt-8 flex items-center justify-between gap-3">
