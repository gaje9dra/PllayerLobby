  ...
  return (
    <SectionContainer className="py-20 sm:py-28">
      <div className="mx-auto max-w-xl rounded-3xl border border-white/10 bg-white/[0.025] px-6 py-14 text-center sm:px-10">
        ...
        <h1 className="mt-3 text-2xl font-black tracking-tight text-white sm:text-3xl">Unable to load tournaments</h1>
        <p className="mt-3 text-sm leading-6 text-slate-500">Something went wrong while loading the tournament catalog. Please try again.</p>
