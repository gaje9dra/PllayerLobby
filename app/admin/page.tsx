    ...
    <SectionContainer className="py-10 sm:py-14">
      ...
      <div className="mt-8 grid gap-5 lg:grid-cols-3">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.025] p-6">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-400">Open the authoritative finance dashboard and inspect wallets, deposits, and existing payout operations.</p>
          <div className="mt-5 flex flex-wrap gap-3"><Button href="/admin/finance" variant="secondary">Finance Dashboard</Button><Button href="/admin/finance/wallets" variant="secondary">Wallets</Button><Button href="/admin/finance/deposits" variant="secondary">Deposits</Button></div>
        </div>
      </div>
    </SectionContainer>
  );
