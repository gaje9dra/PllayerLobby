  ...
  return (
    <SectionContainer>
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex flex-wrap gap-2"><Button href={`/admin/tournaments/${id}/bracket/results`} variant="secondary">Results</Button><Button href={`/admin/tournaments/${id}`} variant="secondary">Back to Tournament</Button></div>
      </div>
