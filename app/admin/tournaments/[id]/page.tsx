  ...
  return (
    <SectionContainer className="py-10 sm:py-14">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-wrap gap-2"><Button href={`/admin/tournaments/${tournament.id}/edit`}>Edit Tournament</Button><Button href={`/admin/tournaments/${tournament.id}/registrations`} variant="secondary">Manage Registrations</Button><Button href={`/admin/tournaments/${tournament.id}/results`} variant="secondary">Manage Results</Button><Button href={`/admin/tournaments/${tournament.id}/prizes`} variant="secondary">Manage Prizes</Button><Button href={`/admin/tournaments/${tournament.id}/room`} variant="secondary">Manage Room</Button></div>
      </div>
