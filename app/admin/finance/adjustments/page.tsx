...
export default async function AdminAdjustmentsPage() {
  ...
  const submitAdjustment = async (formData: FormData): Promise<void> => {
    await createAdjustmentAction(formData);
  };
  ...
  return <SectionContainer className="py-10 sm:py-14">
    ...
    <form action={submitAdjustment} className="mt-7 max-w-2xl space-y-4 rounded-2xl border border-amber-300/20 bg-amber-300/[0.03] p-6">
