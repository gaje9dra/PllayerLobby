...
function formatAdminError(error: unknown) {
  ...
  const destinationCodes = ["DESTINATION_OWNERSHIP_MISMATCH", "DESTINATION_SNAPSHOT_MISMATCH", "MISSING_DESTINATION_SNAPSHOT", "DESTINATION_DATA_CORRUPTED", "DESTINATION_NOT_VERIFIED", "WITHDRAWAL_INTEGRITY_ERROR"];
