-- Phase 5.5 PayU Payouts objects. Enum additions are committed by the prior migration.
...
CREATE UNIQUE INDEX "Payout_active_withdrawal_key" ON "Payout"("withdrawalRequestId") WHERE "status" IN ('PAYOUT_INITIATED', 'PROCESSING');
